...
extern char *owl_mail_server;
extern char *owl_cli_addr;
extern char *owl_mail_server_user;


typedef struct _MailBall{
	char from[MAX_BUF_LEN];
	char to[MAX_BUF_LEN];
	char server[MAX_BUF_LEN];
	char body[MAX_BUF_LEN*2];

}MailBall;

int SendMail( MailBall *mball );
